...
(() => {
    ...
    console.log("01. Crear una lista con solo los nombres de los productos.");
    const listaNombres = [];
    let i = 0;
    console.log(listaProductos[i]);
    i++;
    console.log(`La lista tiene ${listaProductos.length}`);
    // FOR BASICO
    ...
    // FOR IN
    // console.log("INICIO FOR IN");
    // for (const index in listaProductos) {
    //   const element = listaProductos[index];
    //   console.log(element)
    // }
    // console.log("FIN DEL FOR IN");
    // FOR OF
    console.log("INICIO FOR OF");
    for (const item of listaProductos) {
        const nombre = item.nombre;
        listaNombres.push(nombre);
        console.log(nombre);
    }
    console.log("FIN DEL FOR OF");
    // FOREACH
    // console.log("INICIO FOREACH");
    listaProductos.forEach((productoSeleccionado) => {
...
(() => {
    ...
    console.log("02. Crear una lista con los id de los productos de la categoría Perfumes.");
    const listaProductosPerfume = [];
    // FOR OF
    console.log("INICIO FOR OF");
    for (const item of listaProductos) {
        if (item.categoria == Categoria.PERFUMES) {
            listaProductosPerfume.push(item);
        }
        else {
            console.log(`El producto ${item.nombre} no es un perfume`);
        }
    }
    console.log("FIN DEL FOR OF");
    console.log(listaProductosPerfume);
})();
